        ...
        <section className='text-secondary md:py-0 px-8'>
           <div className="flex justify-center">
            ...
            hover:text-black text-center uppercase">
                <a 
                href="mailto:jainambagrecha16@gmail.com?subject=Hello Jainam,...">       
                   Get in Touch  
                </a> 
            </p>
        <motion.footer 
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
                <a href='https://www.linkedin.com/in/jainam-bagrecha-b56248252/' 
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
            <a href='https://github.com/jainam-b' 
            target='_blank' rel='noopener noreferrer'>
                <AiFillGithub/>
            </a>
            </li>
            ...
            <li className="text-2xl hover:opacity-50 cursor-pointer transition-opacity linear duration-1000">
            <a href='https://x.com/Jainambagr67095' 
            target='_blank' rel='noopener noreferrer'>
                <AiOutlineTwitter/>
            </a>
            </li> 
